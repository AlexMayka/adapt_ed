    ...
    "paths": {
        ...
        "/interests": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/interest.ListResponse"
                        }
                    }
                }
            },
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные интереса",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/interest.CreateRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/interest.InterestResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                    ...
                    "409": {
                        "description": "Интерес уже существует",
                        "schema": {
                            "$ref": "#/definitions/dto.ErrorResponse"
                        }
                    }
        ...
        "/interests/verify": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Список ID для верификации",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/interest.VerifyRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/interest.VerifyResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/interest.InterestID"
                        }
                    },
                    "404": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/interest.UpdateRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "409": {
                        "description": "Интерес с таким названием уже существует",
                        "schema": {
                            "$ref": "#/definitions/dto.ErrorResponse"
                        }
                    }
    ...
    "definitions": {
        ...
        "interest.InterestResponse": {
            ...
            "properties": {
                ...
                "icon_key": {
                    "description": "Ключ иконки в S3",
                    "type": "string",
                    "example": "interests/football.png"
                },
                "id": {
                    "description": "UUID интереса",
                    "type": "string",
                ...
                "is_verified": {
                    "description": "Верифицирован ли интерес",
                    "type": "boolean",
                    "example": true
                },
                "name": {
        ...
        "interest.UpdateRequest": {
            "type": "object",
            "properties": {
                "icon_key": {
                    "description": "Ключ иконки",
                    "type": "string",
                    "example": "interests/basketball.png"
                },
                "name": {
                    "description": "Название интереса",
                    "type": "string",
        ...
        "interest.VerifyRequest": {
            ...
            "properties": {
                "ids": {
                    "description": "Список UUID интересов для верификации",
                    "type": "array",
                    "items": {
                        "type": "string"
                    },
